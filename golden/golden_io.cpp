...
void push_input(
    ...
    log_assert(
        ((shuffled_tensor.format == DataFormat::Float32) || (shuffled_tensor.format == DataFormat::Float16) ||
         ...
         (shuffled_tensor.format == DataFormat::RawUInt16) || (shuffled_tensor.format == DataFormat::Int8) || (shuffled_tensor.format == DataFormat::Int32)),
        "Input pytorch tensor can only be FP32/FP16/FP16_b/Raw32/Raw16/Int8/Int32");
