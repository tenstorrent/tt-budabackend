                    ...
                    for (DataFormat input_format : op_info.input_data_formats) {
                        if (op_type == BinaryOp::Add || op_type == BinaryOp::Maximum) {
                            log_assert(
                                ...
                                "Add and Max can have only Int8 or Int32 inputs for integer version of this op input = {} is "
                                "not Int8/Int32",
                                input_format);
                        }
                        else {
                            log_assert(
                                ...
                                "Add/Sub/Mul can have only Int8 inputs for integer version of these ops input = {} is not "
                                "Int8",
                                input_format);
                        }
                    }
