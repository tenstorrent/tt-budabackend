...
struct tt_cluster
{
    ...
    std::set<uint32_t> cols_to_exclude_for_wormhole_dram_broadcast_group_1 = {0, 1, 2, 3, 4, 6, 7, 8, 9};
    std::set<uint32_t> rows_to_exclude_for_wormhole_dram_broadcast_group_2 = {2, 3, 4, 8, 9, 10};
    std::set<uint32_t> cols_to_exclude_for_wormhole_dram_broadcast_group_2 = {1, 2, 3, 4, 5, 6, 7, 8, 9};
