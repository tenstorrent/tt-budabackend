...
struct GRAYSKULL_DEVICE_DATA {
    ...
    // This is used to get channel 0 address in SIlicon driver. Do we wanna generalize that function in case different stacks want to statically map different parts of device memory?
