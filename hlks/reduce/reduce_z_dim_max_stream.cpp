...
{
    constexpr int32_t HALF_DEST_SIZE = 4;
    int num_iter = (args->block_tile_dim > HALF_DEST_SIZE || args->is_32bit_dest_en) ? 2 : 1; // Number of iterations through dest per block
