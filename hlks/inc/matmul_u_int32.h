...
constexpr int MATMUL_U_INT32_MAX_NUM_INPUTS = 4;
...
struct hlk_args_t {
    ...
    int kernel_broadcast[MATMUL_U_INT32_MAX_NUM_INPUTS];
    int kernel_broadcast_per_t[MATMUL_U_INT32_MAX_NUM_INPUTS];
    int sfpu_op;
