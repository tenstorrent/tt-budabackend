...
void hlk_process_single_input(tt_core *core_ptr, const hlk_args_t *args) {
    ...
    for (int t=0; t<total_block_tiles; t=t+2) {    
        hlk_acquire_dst(core_ptr);
        copy_index_and_data_tiles_to_dest(core_ptr, HlkOperand::intermed0, HlkOperand::intermed1, t, t+1);
        ...
        pack_index_and_data_tiles_from_dest(core_ptr, HlkOperand::intermed0, HlkOperand::intermed1, t, t+1);
        hlk_release_dst(core_ptr);
