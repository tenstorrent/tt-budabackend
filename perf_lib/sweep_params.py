...
perf_sweep_output_vars_default = {
    ...
    'output_df': [2],
    "intermed_df": [2],         # This will get overriden to output data format unless l1 acc
}
...
perf_sweep_vars_for_op = {
    ...
    OpType.Binary: {
        'binary_type': [i for i in range(1, 4)] # using the verif.template_netlist.test_modules.constraint_utils.BinaryType
    },
    OpType.Dram: {
        'output_grid_size_r': [1],
        'output_grid_size_c': [1],
