...
OP_MODEL_LDFLAGS = -L$(BUDA_HOME) -lyaml-cpp # -lnetlist
OP_MODEL_CFLAGS = $(CFLAGS) -Werror -Wall
...
$(OP_MODEL): $(OP_MODEL_OBJS)
	@mkdir -p $(@D)
	$(CXX) $(OP_MODEL_CFLAGS) $(CXXFLAGS) $(STATIC_LIB_FLAGS) $(OP_MODEL_INCLUDES) $(OP_MODEL_DEFINES) -o $@ $^ $(LDFLAGS) $(OP_MODEL_LDFLAGS)

$(OP_MODEL_LIB): $(COMMON_LIB) $(NETLIST_LIB) $(OP_MODEL_OBJS)
	@mkdir -p $(@D)
	ar rcs -o $@ $(OP_MODEL_OBJS)

$(OBJDIR)/perf_lib/op_model/%.o: perf_lib/op_model/%.cpp 
	@mkdir -p $(@D)
	$(CXX) $(OP_MODEL_CFLAGS) $(CXXFLAGS) $(STATIC_LIB_FLAGS) $(OP_MODEL_INCLUDES) $(OP_MODEL_DEFINES) -c -o $@ $< $(OP_MODEL_LDFLAGS)
