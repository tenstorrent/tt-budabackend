...
uint32_t get_op_cycles_for_perf_sweep_result(const std::unordered_map<std::string, std::string>& perf_sweep_result, const std::string& op_type, const std::string& op_name, const std::string& arch, const std::string& sparse_formula) {
    log_assert(
