...
class PerfSweepDescriptor:
    ...
    def parse_args_and_generate_state(self, script_args):
        ...
        parser.add_argument("--op-type", type=str, default="",
            help="The op type to run the sweep for. Currently following ops are supported: matmul, matmul_bias, binary, unary, dram, dram_read, dram_write, fused_op_0, fused_op_1, fused_op_2, pcie, matmul_sparse, matmul_sparse_nz_counts, reduce_max, splice, matmul_l1_acc.",
        )
