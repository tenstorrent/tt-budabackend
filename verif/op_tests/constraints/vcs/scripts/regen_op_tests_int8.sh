...
make DEVICE=${device} TARGET_FILE=configs/wormhole_b0/matmul/matmul.int8.quant.nightly HARVESTED_ROWS=2 LOOPS=20 SEED=0 C=main_program.sv TLIST=int8.quant.nightly ARGS='+op=matmul +int8=1 +quantize=1'
...
make DEVICE=${device} HARVESTED_ROWS=2 LOOPS=30 SEED=0 C=unary/unary_op_constraints.sv TLIST=int8.nightly ARGS='+int8=1'
