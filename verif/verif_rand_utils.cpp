...
void verif::random::generate_with_step(tt_tensor &tensor, float start, float increment) {
    float current_value = start;

    tensor.reserve_tile_tensor();
    tensor.apply([&](tt_tile &tile) {
        for (int i = 0; i < tile.tile_height; ++i) {
            for (int j = 0; j < tile.tile_width; ++j) {
                tile.set(i, j, current_value);
...
template void verif::random::randomize_normal<uint8_t>(tt_tensor &, uint8_t, uint8_t);
...
template void verif::random::randomize_uniform<uint8_t>(tt_tensor &, uint8_t, uint8_t);
...
template void verif::random::randomize_normal<uint8_t>(
    tt_tensor &, uint8_t, uint8_t, const std::pair<int, int> &, const std::pair<int, int> &);
...
template void verif::random::randomize_uniform<uint32_t>(
    tt_tensor &, uint32_t, uint32_t, const std::pair<int, int> &, const std::pair<int, int> &);
template void verif::random::randomize_uniform<uint8_t>(
    tt_tensor &, uint8_t, uint8_t, const std::pair<int, int> &, const std::pair<int, int> &);
...
template void verif::random::set_number<uint8_t>(tt_tensor &, uint8_t);
...
template void verif::random::set_number<uint8_t>(
    tt_tensor &, uint8_t, const std::pair<int, int> &, const std::pair<int, int> &);
