...
def get_num_input_operands(test_type: PerfTestType):
    if (
        test_type == PerfTestType.Unary
        or test_type == PerfTestType.TM
        or test_type == PerfTestType.Dram
        or test_type == PerfTestType.Pcie
        or test_type == PerfTestType.ReduceMax
        or test_type == PerfTestType.Tilizer
    ):
        return 1
    elif test_type == PerfTestType.Matmul or test_type == PerfTestType.Binary:
        return 2
    elif (
        test_type == PerfTestType.MatmulBias
        or test_type == PerfTestType.Fused0
        or test_type == PerfTestType.MatmulSparse
        or test_type == PerfTestType.MatmulSparseNzCounts
        or test_type == PerfTestType.Splice
    ):
        return 3
...
def is_matmul_op(test_type):
    if (
        test_type == PerfTestType.Matmul
        or test_type == PerfTestType.MatmulBias
        or test_type == PerfTestType.MatmulSparse
        or test_type == PerfTestType.MatmulSparseNzCounts
    ):
        return True
