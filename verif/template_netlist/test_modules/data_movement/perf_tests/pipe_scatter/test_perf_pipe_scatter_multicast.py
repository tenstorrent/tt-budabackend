...
class PipeScatterMulticastPerfTest(DataMovementPerfTestBase):
    ...
    def additional_constraints(self) -> None:
        ...
        self.solver.add(feeder1.grid_size_x == 1, feeder1.grid_size_y == 1)
...
pipe_perf_test: PipeScatterMulticastPerfTest = None
...
def constraint_model(solver: Solver, svars: dict, arch_name: str, harvested_rows: int = 0):
    ...
    pipe_perf_test = PipeScatterMulticastPerfTest(
        solver=solver,
        svars=svars,
