...
template_yaml = os.path.join(
    get_git_root(),
    f"verif/template_netlist/templates/data_movement/pipe_tests/direct_pipe/test_dram_unicast_pipe.template.yaml",
)


class DramUnicastPipeTest(DataMovementPipeTestBase):
    # @override
...
pipe_test: DramUnicastPipeTest = None
