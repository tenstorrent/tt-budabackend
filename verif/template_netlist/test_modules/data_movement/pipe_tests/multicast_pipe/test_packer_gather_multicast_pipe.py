...
from test_modules.common.enums import Untilize, UblockOrder
...
template_yaml = os.path.join(
    get_git_root(),
    f"verif/template_netlist/templates/data_movement/pipe_tests/multicast_pipe/test_packer_multicast_pipe.template.yaml",
)


class PackerGatherMulticastPipeTest(DataMovementPipeTestBase):
    # @override
    def additional_constraints(self) -> None:
        ...
        # Ensure there is gather on the left input of matmul.
        constrain_node_grid_size_greater_than_one(self.solver, feeder0)
    ...
    def export_sweep_vars(self) -> List[SweepVarsGroup]:
        mblock_range = list(range(40, 64, 2))
...
pipe_test: PackerGatherMulticastPipeTest = None
...
def constraint_model(solver: Solver, svars: dict, arch_name: str, harvested_rows: int = 0):
    ...
    pipe_test = PackerGatherMulticastPipeTest(
        solver=solver,
        svars=svars,
