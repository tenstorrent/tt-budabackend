...
def get_queue_buffer_size(data_format, num_entries, t, mblock_dim, ublock_dim):

    if data_format == DataFormat.RawUInt32.name:
        tile_size = FP32_TILE_SIZE
    elif data_format == DataFormat.Float16.name or data_format == DataFormat.Float16_b.name:
        tile_size = FP16_TILE_SIZE
    elif data_format == DataFormat.Bfp8.name or data_format == DataFormat.Bfp8_b.name:
        tile_size = BFP8_TILE_SIZE
    elif data_format == DataFormat.Bfp4.name or data_format == DataFormat.Bfp4_b.name:
        tile_size = BFP4_TILE_SIZE
    elif data_format == DataFormat.Bfp2.name or data_format == DataFormat.Bfp2_b.name:
        tile_size = BFP2_TILE_SIZE
    else:
...
def is_format_type_a(data_format):
    if data_format in [DataFormat.Bfp2, DataFormat.Bfp4, DataFormat.Bfp8, DataFormat.Float16]:
        return True
    
    if data_format in [DataFormat.Bfp2_b, DataFormat.Bfp4_b, DataFormat.Bfp8_b, DataFormat.Float16_b]:
        return False
