...
from util import dump_config_yaml
...
class WorkerSolutionHandler:
    ...
    def process_sat(
        self, config: Dict[str, int | str], combination_name: str, config_dir_path: Optional[str]
    ) -> None:
        """
