...
class SolutionDict(dict):
    ...
    def can_add_new_config(self, combination_name: str, config: Dict[str, int]) -> bool:
        """Wrapper for SweepCombination can_add_new_config."""
        return self[combination_name].can_add_new_config(config)
