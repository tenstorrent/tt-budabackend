...
template_yaml = f'{TEMPLATE_DIR_PATH}/test_datacopy_fork_datacopy.template.yaml'
...
def constraint_model(solver,svars):
    ...
    solver.add(svars['op0_loc_c'] >= svars['input_grid_size_c'])
    solver.add(svars['op0_loc_r'] + svars['output0_grid_size_r'] <= svars['input_grid_size_r'])
    solver.add(svars['op0_loc_c'] + svars['output0_grid_size_c'] <= GRAYSKULL_GRID_C)
    # bottom of feeder
    solver.add(svars['op1_loc_r'] >= svars['input_grid_size_r'])
    solver.add(svars['op1_loc_c'] >= 0)
    solver.add(svars['op1_loc_r'] + svars['output1_grid_size_r'] <= GRAYSKULL_GRID_R)
    solver.add(svars['op1_loc_c'] + svars['output1_grid_size_c'] <= svars['input_grid_size_c'])
