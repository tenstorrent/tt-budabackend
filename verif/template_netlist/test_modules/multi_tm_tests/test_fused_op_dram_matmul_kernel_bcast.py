...
template_yaml = os.path.join(
    get_git_root(),
    'verif/template_netlist/templates/test_fused_op_dram_matmul_kernel_bcast.template.yaml'
)
...
class FusedOpDramMatmulKernelBroadcastTest(MultiTMFusedOpKernelBroadcastTestBase):
...
multi_tm_test: FusedOpDramMatmulKernelBroadcastTest = None
...
def constraint_model(solver: Solver, svars: dict, arch_name: str, harvested_rows: int = 0):
    ...
    multi_tm_test = FusedOpDramMatmulKernelBroadcastTest(
        solver=solver,
        svars=svars,
