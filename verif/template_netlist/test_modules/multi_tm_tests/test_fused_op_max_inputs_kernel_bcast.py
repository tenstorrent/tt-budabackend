...
template_yaml = os.path.join(
    get_git_root(),
    'verif/template_netlist/templates/test_fused_op_max_inputs_kernel_bcast.template.yaml'
)
...
class FusedOpStreamingMaxInputsKernelBroadcastTest(MultiTMFusedOpKernelBroadcastTestBase):
    ...
    def additional_constraints(self) -> None:
        ...
        # Force [1, 1] grid size throughout all the ops and queues in the netlist.
...
multi_tm_test: FusedOpStreamingMaxInputsKernelBroadcastTest = None
...
def constraint_model(solver: Solver, svars: dict, arch_name: str, harvested_rows: int = 0):
    ...
    multi_tm_test = FusedOpStreamingMaxInputsKernelBroadcastTest(
        solver=solver,
        svars=svars,
