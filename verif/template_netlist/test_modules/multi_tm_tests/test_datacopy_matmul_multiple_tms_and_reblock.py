...
template_yaml = os.path.join(
    ...
    f"test_datacopy_matmul_multiple_tms_and_reblock{test_type_extension}.template.yaml",
)
...
class DatacopyMatmulMultiTmTest(MultiTmTestBase):
...
multi_tm_test: DatacopyMatmulMultiTmTest = None
...
def constraint_model(solver: Solver, svars: dict, arch_name: str, harvested_rows: int = 0):
    ...
    multi_tm_test = DatacopyMatmulMultiTmTest(
        solver=solver,
        svars=svars,
