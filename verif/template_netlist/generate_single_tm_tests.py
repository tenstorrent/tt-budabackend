...
def generate_test_netlist_for_tm(
    ...
    compress_netlists(
        output_dir,
        f"verif/template_netlist/netlists/single_tm_tests/push/{arch_name}",
        zip_name,
    )
...
def generate_basic_configuration_tests(
    output_dir, harvested_rows, is_padding=False, arch_name="grayskull"
) -> None:
    """
...
if __name__ == "__main__":
    ...
    generate_basic_configuration_tests(args.output_dir, args.harvested_rows, arch_name=args.arch)

    # # Generate datacopy->dram_output
    generate_test_netlist_for_tm(
        args.output_dir,
        args.harvested_rows,
    ...
    generate_basic_configuration_tests(
        args.output_dir, args.harvested_rows, is_padding=True, arch_name=args.arch
    )
