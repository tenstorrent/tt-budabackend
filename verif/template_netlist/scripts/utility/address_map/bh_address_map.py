...
class BHAddressMap(AddressMap):
    ...
    NCRISC_L1_RUNTIME_SECTION_BASE = EPOCH_RUNTIME_CONFIG_BASE + EPOCH_RUNTIME_CONFIG_SIZE + OVERLAY_BLOB_SIZE
    NCRISC_L1_RUNTIME_SECTION_SIZE = 16 * 1024
    NCRISC_L1_SCRATCH_BASE = NCRISC_L1_RUNTIME_SECTION_BASE + 0x200
    NCRISC_L1_CONTEXT_BASE = NCRISC_L1_RUNTIME_SECTION_BASE + 0x20
    NCRISC_L1_DRAM_POLLING_CTRL_BASE = NCRISC_L1_RUNTIME_SECTION_BASE + 0x40
    NCRISC_PERF_QUEUE_HEADER_SIZE = 8 * 8
    NCRISC_PERF_QUEUE_HEADER_ADDR = NCRISC_L1_RUNTIME_SECTION_BASE + NCRISC_L1_SCRATCH_SIZE
    ...
    DATA_BUFFER_SPACE_BASE = NCRISC_L1_RUNTIME_SECTION_BASE + NCRISC_L1_RUNTIME_SECTION_SIZE
    ...
    def get_regions(self):
        ...
        regions = [
            ...
            MemoryRegion(
                "NCRISC_L1_RUNTIME_SECTION", self.NCRISC_L1_RUNTIME_SECTION_BASE, self.NCRISC_L1_RUNTIME_SECTION_SIZE
            ),
            MemoryRegion(
            ...
            # from tensix-memory-noiram.ld
            MemoryRegion("NOCRISC_DATA", 0x33000, size=4 * 1024),
            MemoryRegion("NOCRISC_CODE", 0x5000, size=16 * 1024),
            # MemoryRegion("NOCRISC_L1_CODE", 0x9000, size=16 * 1024),  # duplicate of NCRISC_L1_CODE
            # MemoryRegion("NOCRISC_L1_SCRATCH", 0x33200, size=3584),  # duplicate of NCRISC_L1_SCRATCH
        ]
