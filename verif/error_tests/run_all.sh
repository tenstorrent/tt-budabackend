...
VERIF_ERROR_TESTS=(
    ...
    "./build/test/verif/error_tests/test_errors --netlist verif/error_tests/netlists/invalid/fused_op/netlist_fused_op_with_matmul_input1_not_column.yaml  >> ./build/test/verif/error_tests/output.txt"
