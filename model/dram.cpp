...
//        }
    ...
    tt_chan_alloc_struct::tt_chan_alloc_struct(uint64_t tr, uint64_t tstart_table, uint64_t tb, uint64_t tchan, uint64_t eqslot_size, uint64_t top_q_update)
    {
        top_of_reserved = tr;
        top_of_epoch0_start_table = tstart_table;
        top_of_binaries = tb;
        top_of_chan = tchan;
        current_bin_ptr = top_of_epoch0_start_table;
        ...
        epoch_q_start = top_of_epoch0_start_table;
