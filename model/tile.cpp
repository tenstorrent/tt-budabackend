...
namespace tt {
    ...
    static constexpr int get_nums_in_dword()
    {
        ...
        else if((data_format == DataFormat::Float16) || (data_format == DataFormat::Float16_b) || (data_format == DataFormat::RawUInt16))
        {
            return 2;
        }
        else if((data_format == DataFormat::Bfp8) || (data_format == DataFormat::Bfp8_b) || (data_format == DataFormat::Lf8) || (data_format == DataFormat::RawUInt8) || (data_format == DataFormat::Int8))
        {
            return 4;
        }
    ...
    static TT_TILE_FORCE_INLINE uint32_t convert_num_format(uint32_t num_index_in_tile, uint32_t num, const vector<uint32_t>& packed_data)
    {
        ...
        switch(data_format)
        {
            ...
            case DataFormat::UInt16   : log_fatal("UInt16 is not supported");; break;
