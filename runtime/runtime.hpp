...
class tt_runtime : public tt_backend
{
    ...
    void create_graph_overlay_binaries();
    void update_graph_overlay_binaries();
    void wrap_graph_overlay_binaries_creation(std::function<void(int, const std::unordered_map<chip_id_t, buda_soc_description>&)> creator_function);
    void create_temporal_epoch_overlay_binaries(int temporal_epoch, const std::unordered_map<chip_id_t, buda_soc_description>& sdesc_per_chip);
