...
constexpr std::int32_t pack_src_format[16]   = {(std::int32_t) DataFormat::__src_format__ ,0,0,0,0,0,0,0,
                                                (std::int32_t) DataFormat::__intermediate0_src_format__,(std::int32_t) DataFormat::__intermediate1_src_format__,0,0,0,0,0,0};
constexpr std::int32_t pack_dst_format[16]   = {(std::int32_t) DataFormat::__dst_format__ ,0,0,0,0,0,0,0,
