...
$binary_intermediate_streaming_test_graph = {}
...
for p in 1..num_phases
  ...
  if !$binary_intermediate_streaming_test_graph[phase]
    $binary_intermediate_streaming_test_graph[phase] = {}
  end

  resend = output0_no_resend ? false : (((p-1) % num_microblocks_in_buf) == 0 ? false : true)

  $binary_intermediate_streaming_test_graph[phase][output0_data_stream] = {
    :output_index => 0,
    :auto_run => true,
    :buf_addr => buf_addr,
    :buf_size => buf_size,
