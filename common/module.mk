...
COMMON_INCLUDES += -Icommon -Imodel -Inetlist -Iumd
COMMON_LDFLAGS = -L$(BUDA_HOME) -lyaml-cpp -lhwloc
COMMON_CFLAGS = $(CFLAGS) -Werror -Wall -Wno-unknown-pragmas -Wno-reorder -Wno-strict-aliasing

COMMON_SRCS += \
	$(wildcard common/model/*.cpp) \
	$(wildcard common/*.cpp) \
	$(wildcard common/multichip/*.cpp)
