...
protected:
    ...
    std::unique_ptr<DataFlowNodeMock> make_root_df_node_mock(unsigned int epoch_tiles,
                                                             ...
                                                             unsigned int tiles_per_input)
    {
        return make_df_node_mock(scatter_gather_num_tiles > 0 /* is_scatter */,
                                 1 /* num_input_groups */,
                                 epoch_tiles,
    ...
    std::unique_ptr<DataFlowNodeMock> make_virtual_df_node_mock(unsigned int repeat_factor,
                                                                unsigned int serialization_factor)
    {
        return make_df_node_mock(false /* is_scatter */,
                                 1 /* num_input_groups */,
                                 1 /* epoch_tiles */,
                                 1 /* consume_granularity */,
                                 false /* can_do_epoch_in_single_iter */,
...
TEST_F(Pipegen2_TransferLimitsCalculator_CalculateTransferLimits, CompundSanityDataFlowGraph)
{
    ...
    std::unique_ptr<DataFlowNodeMock> gather_node_1 = make_virtual_df_node_mock(
        3 /* repeat_factor */, 2 /* serialization_factor */);
    std::unique_ptr<DataFlowNodeMock> gather_node_2 = make_virtual_df_node_mock(
        3 /* repeat_factor */, 2 /* serialization_factor */);

    std::unique_ptr<DataFlowNodeMock> union_node = make_union_df_node_mock(2 /* input_group_count */);
    std::unique_ptr<DataFlowNodeMock> unpacker_leaf = make_leaf_df_node_mock(
        8 /* consume_granularity */, false /* can_do_epoch_in_single_iter */);
    ...
    verify_transfer_limits(packer_root_1.get(),
    ...
    verify_transfer_limits(packer_root_2.get(),
                           false /* is_on_single_source_path */,
                           1200 /* num_iterations */,
                           2 /* tiles_to_send */,
                           1 /* number_of_unique_df_paths_through_node */,
    ...
    verify_transfer_limits(gather_node_1.get(),
                           false /* is_on_single_source_path */,
                           1800 /* num_iterations */,
                           10 /* tiles_to_send */,
                           1 /* number_of_unique_df_paths_through_node */,
    ...
    verify_transfer_limits(gather_node_2.get(),
                           false /* is_on_single_source_path */,
                           1800 /* num_iterations */,
                           10 /* tiles_to_send */,
                           1 /* number_of_unique_df_paths_through_node */,
    ...
    verify_transfer_limits(union_node.get(),
                           false /* is_on_single_source_path */,
                           1800 /* num_iterations */,
                           10 /* tiles_to_send */,
    ...
    verify_transfer_limits(unpacker_leaf.get(),
                           false /* is_on_single_source_path */,
                           1800 /* num_iterations */,
                           10 /* tiles_to_send */,
                           2 /* number_of_unique_df_paths_through_node */,
