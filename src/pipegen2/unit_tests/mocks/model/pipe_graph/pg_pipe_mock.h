...
public:
    ...
    PGPipeMock(
        ...
        NOC_ROUTE incoming_noc_id,
        const int incoming_vc,
        NOC_ROUTE outgoing_noc_id,
    ...
    std::vector<std::string> to_json_list_of_strings_all_attributes()
    {
        return {
            ...
            "incoming_noc_id: " + std::to_string(static_cast<unsigned int>(get_incoming_noc_id())),
            "incoming_vc: " + std::to_string(get_incoming_noc_vc()),
            "outgoing_noc_id: " + std::to_string(static_cast<unsigned int>(get_outgoing_noc_id())),
