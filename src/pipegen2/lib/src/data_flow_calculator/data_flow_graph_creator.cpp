    ...
    const RationalGraph* rational_graph)
{
    ...
    std::vector<std::unique_ptr<DataFlowNode>> data_flow_nodes =
        create_data_flow_nodes(rational_graph, rg_node_to_df_node);
...
std::vector<std::unique_ptr<DataFlowNode>> DataFlowGraphCreator::create_data_flow_nodes(
    const RationalGraph* rational_graph, std::unordered_map<const RGBaseNode*, DataFlowNode*>& rg_node_to_df_node)
{
    std::vector<std::unique_ptr<DataFlowNode>> data_flow_nodes;
...
void DataFlowGraphCreator::create_data_flow_edges(
    const RationalGraph* rational_graph, const std::unordered_map<const RGBaseNode*, DataFlowNode*>& rg_node_to_df_node)
{
...
void DataFlowGraphCreator::create_data_flow_edges_from_pipe(
    const RGBasePipe* rg_pipe, const std::unordered_map<const RGBaseNode*, DataFlowNode*>& rg_node_to_df_node)
{
