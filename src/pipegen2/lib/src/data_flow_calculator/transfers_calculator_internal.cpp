...
int calculate_phases(DataFlowNode* df_node, const unsigned int data_offset, DataFlowNode* dest,
                     const unsigned int start_phase_offset) {
...
int calculate_phases_for_root(DataFlowNode* df_node, unsigned int data_offset, DataFlowNode* dest,
...
bool can_sender_accumulate(DataFlowNode* dest, DataFlowNode* prev_sender, unsigned int prev_data_offset,
                           DataFlowNode* current_sender, unsigned int current_data_offset) {
...
void calculate_sending_phases(DataFlowNode* df_node, unsigned int data_offset, DataFlowNode* dest,
                              unsigned int start_phase_offset) {
