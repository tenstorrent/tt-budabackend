...
TransferLimitsCalculator::TransferLimitsCalculator(
    unsigned int max_num_tiles_per_phase, unsigned int max_num_phases_per_iteration) :
    m_max_num_tiles_per_phase(max_num_tiles_per_phase), m_max_num_phases_per_iteration(max_num_phases_per_iteration)
{
}

void TransferLimitsCalculator::calculate_transfer_limits(
...
void TransferLimitsCalculator::calculate_num_iterations(
