...
StreamId WorkerCoreResourcesWH::get_next_available_gather_multicast_stream_id()
{
    ...
    {
        ERROR("WorkerCoreResourcesWH: Out of available streams used for gather and multicast on core "
...
StreamId WorkerCoreResourcesWH::get_packer_multicast_stream_id(int operand_id)
{
    ...
    {
        ERROR("WorkerCoreResourcesWH: Trying to allocate packer-multicast stream on a worker core " <<
