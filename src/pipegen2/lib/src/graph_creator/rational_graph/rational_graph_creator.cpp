...
namespace pipegen2
{
                                                                                 ...
                                                                                 ResourceManager* resource_manager)
    {
        ...
        {
            throw std::runtime_error("RationalGraphCreator: Unsupported input buffer type");
        }
    }
                                                                             ...
                                                                             ResourceManager* resource_manager)
    {
        ...
        {
            throw std::runtime_error("RationalGraphCreator: Unsupported output buffer type");
        }
    }
                                                                                 ...
                                                                                 ResourceManager* resource_manager)
    {
        ...
        {
            throw std::runtime_error("RationalGraphCreator: Unsupported intermed buffer.");
        }
    }
        ...
        const SoCInfo* soc_info)
    {
        ...
        {
            throw std::runtime_error("RationalGraphCreator: Unsupported pipe type.");
        }
    }
        ...
        std::vector<std::unique_ptr<RGBaseNode>>& rational_graph_nodes)
    {
        ...
        else if (subgraph_pipe->is_direct_intermediate_pipe())
        {
            ...
            {
                throw std::runtime_error("RationalGraphCreator: Unsupported intermed pipe.");
            }
        }
        ...
        std::vector<std::unique_ptr<RGBaseNode>>& rational_graph_nodes)
    {
        ...
        {
            ASSERT(pg_pipe_outputs[0]->is_dram_output(), "Expected dram output");
    ...
    std::unique_ptr<VirtualNode> RationalGraphCreator::wrap_into_virtual_node(const PGBuffer* pg_buffer)
    {
        ...
        ASSERT(rg_node != nullptr, "Expected node to be created for buffer");
    ...
    void RationalGraphCreator::ensure_optimized_packer_multicast_is_first_fork(RGBasePipe* fork_pipe)
    {
        ...
        for (std::size_t i = 1; i < fork_pipe->get_output_nodes().size(); ++i)
        {
            ...
            ASSERT(!found_optimized_packer_multicast_fork,
    ...
    DramInputNodeType RationalGraphCreator::get_input_dram_buffer_type(const PGBuffer* input_dram_buffer)
    {
        ...
        {
            throw std::runtime_error("RationalGraphCreator: Unsupported dram input buffer.");
        }
    };
