...
void PipeGraphInfo::add_scatter_buffer_pipe_input(NodeId node_id, 
...
PGBuffer* PipeGraphInfo::get_pg_buffer_by_node_id(NodeId buffer_id) const
{
    return m_buffers_per_id.at(buffer_id);
}
