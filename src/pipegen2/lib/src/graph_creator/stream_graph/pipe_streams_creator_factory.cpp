...
namespace pipegen2
{
PipeStreamsCreatorFactory::PipeStreamsCreatorFactory(tt::ARCH device_arch) : m_device_arch(device_arch) {}
    ...
    std::unordered_map<const VirtualNode*, StreamPhasesCommonConfig>* virt_node_to_stream_node)
{
    ...
    return creator_it == m_creators_map.end()
               ? m_creators_map
                     .emplace(
                         pipe_type, create_pipe_streams_creator(pipe_type, resource_manager, virt_node_to_stream_node))
                     .first->second.get()
    ...
    std::unordered_map<const VirtualNode*, StreamPhasesCommonConfig>* virt_node_to_stream_node)
{
    ...
    {
        return create_generic_pipe_streams_creator<UnicastStreamsCreator>(resource_manager, virt_node_to_stream_node);
    }
    ...
    {
        return create_generic_pipe_streams_creator<MulticastStreamsCreator>(resource_manager, virt_node_to_stream_node);
    }
    ...
    {
        return create_generic_pipe_streams_creator<GatherStreamsCreator>(resource_manager, virt_node_to_stream_node);
    }
    ...
    {
        return create_generic_pipe_streams_creator<RelayStreamsCreator>(resource_manager, virt_node_to_stream_node);
    }
    ...
    {
        return create_generic_pipe_streams_creator<UnionStreamsCreator>(resource_manager, virt_node_to_stream_node);
    }
    else
    {
