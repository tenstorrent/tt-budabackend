...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(intermed_pipe != nullptr, "Expecting SharedPackerIntermedPipe in SharedPackerIntermedStreamsCreator");
        ...
        ASSERT(virtual_input_node != nullptr, "Expecting VirtualNode at SharedPackerIntermedPipe input");
        ASSERT(intermed_input_node != nullptr, "Expecting SharedPackerIntermedNode at SharedPackerIntermedPipe input");
        ASSERT(intermed_output_node != nullptr,
               "Expecting SharedPackerIntermedNode at SharedPackerIntermedPipe output");
