...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(multicast_pipe, "MulticastStreamsCreator invoked for wrong type of pipe");
        ...
        ASSERT(virt_node, "Expecting virtual node at the Multicast pipe input");
                                                                    ...
                                                                    StreamNode* input_stream)
    {
        ...
        ASSERT(input_stream->get_stream_type() == StreamType::Gather ||
