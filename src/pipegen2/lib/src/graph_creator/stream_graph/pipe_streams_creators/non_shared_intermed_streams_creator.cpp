...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(intermed_pipe != nullptr, "Expecting NonSharedIntermedPipe in NonSharedIntermedStreamsCreator");
        ...
        ASSERT(intermed_input_node != nullptr, "Expecting NonSharedIntermedNode at NonSharedIntermedPipe input");
        ASSERT(intermed_output_node != nullptr, "Expecting NonSharedIntermedNode at NonSharedIntermedPipe input");
