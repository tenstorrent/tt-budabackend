...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(dram_tilizer_pipe, "DramTilizerStreamsCreator invoked for inadequate pipe");
        ...
        std::vector<NcriscConfig> ncrisc_configs =
            m_ncrisc_creator->configure_dram_tilizer_ncrisc_reader(
                data_flow_info,
                pipe,
        ...
        ASSERT(ncrisc_configs.size() == 1, "Expecting only one NCRISC config for DramTilizer pipe");
