...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(dram_gather_pipe, "DramGatherStreamsCreator invoked for inadequate pipe");
        ...
        ASSERT(ncrisc_configs.size() > 1, "Expecting more than one NCRISC config for DramGather pipe");
