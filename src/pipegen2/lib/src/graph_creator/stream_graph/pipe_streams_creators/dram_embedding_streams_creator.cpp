...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(dram_embedding_pipe, "DramEmbeddingStreamsCreator invoked for inadequate pipe");
        ...
        ASSERT(ncrisc_configs.size() == 1, "Expecting only one NCRISC config for DramEmbedding pipe");
