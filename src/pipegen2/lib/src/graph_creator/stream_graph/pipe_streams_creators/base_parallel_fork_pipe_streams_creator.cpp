...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(pipe->get_inputs().size() == 1, "Expecting single input to the parallel fork pipe");
        ...
        for (std::size_t i = 0; i < pipe_outputs.size(); ++i)
        {
            ...
            ASSERT(out_virt_node != nullptr, "Expecting virtual node at the parallel fork pipe output");
