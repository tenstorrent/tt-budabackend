...
namespace pipegen2
{
        ...
        const DataFlowInfo& data_flow_info)
    {
        ...
        ASSERT(dram_unicast_pipe, "DramUnicastStreamsCreator invoked for inadequate pipe");
        ...
        ASSERT(ncrisc_configs.size() == 1, "Expecting exactly one NCRISC config for DramUnicast pipe");
