...
namespace pipegen2
{
    ...
    unsigned int DataFlowNode::get_repeat_factor() const
    {
    ...
    {
        return is_untilized_dram_output() || is_intermediate();
    }
    ...
    unsigned int DataFlowNode::get_size_tiles() const
    {
        return m_rg_node->get_size_tiles();
    }

    unsigned int DataFlowNode::get_num_tiles_per_input() const
    {
        return m_rg_node->get_tiles_per_input();
    }
    ...
    bool DataFlowNode::is_isolated_node() const
    {
