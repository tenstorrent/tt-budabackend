...
namespace pipegen2
{
    ...
    {
        ASSERT(m_inputs.size() > 0, "Expecting DramTilizerPipe to have at least 1 input");
        ...
        ASSERT(dram_embedding_table, "Expected DramEmbeddingTableInputNode as first input to DramTilizer pipe");
