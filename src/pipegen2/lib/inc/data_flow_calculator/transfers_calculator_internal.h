...
int calculate_phases(DataFlowNode* df_node, unsigned int data_offset, DataFlowNode* dest,
...
bool can_sender_accumulate(DataFlowNode* df_node, DataFlowNode* prev_sender, unsigned int prev_data_offset,
