...
namespace pipegen2
{
    ...
    public:
        ...
        {
            ASSERT(phase_index < m_phase_configs.size(), "Invalid phase index");
        ...
        {
            ASSERT(m_base_config.get_num_iters_in_epoch().has_value(), "Stream has no num iterations in epoch");
    ...
    private:
        ...
        {
            ASSERT(max_num_tiles_per_phase > 0, "Max num tiles per phase must be positive");
