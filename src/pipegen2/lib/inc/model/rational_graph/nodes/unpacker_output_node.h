...
namespace pipegen2
{
    ...
    {
    public:
        UnpackerOutputNode(NodeId node_id,
            ...
            BaseOutputNode(node_id, RGNodeType::UnpackerOutput, physical_location, size_tiles, tile_size,
                           num_epoch_tiles, tiles_per_input, operand_id, transfer_granularity,
