...
namespace pipegen2
{
    class SharedPackerIntermedNode : public BaseIntermedNode
    {
    public:
        SharedPackerIntermedNode(NodeId node_id,
            ...
            BaseIntermedNode(node_id, RGNodeType::SharedPackerIntermed, physical_location, size_tiles, tile_size,
