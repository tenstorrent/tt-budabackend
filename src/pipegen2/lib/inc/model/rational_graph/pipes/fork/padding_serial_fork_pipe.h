...
namespace pipegen2
{
    ...
    {
    public:
        PaddingSerialForkPipe(RGPipeProperties&& rg_pipe_properties,
                              const tt_cxy_pair& physical_location,
                              unsigned int num_serial_outputs,
                              unsigned int num_serial_padding_outputs) :
            SerialForkPipe(std::move(rg_pipe_properties), physical_location,
                           num_serial_outputs, num_serial_padding_outputs)
        {
