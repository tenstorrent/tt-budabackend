...
public:
    ...
    void set_dram_io_flag_is_remote(bool dram_io_flag_is_remote) { m_dram_io_flag_is_remote = dram_io_flag_is_remote; }
    ...
    void set_use_ethernet_fw_stream(bool use_ethernet_fw_stream) { m_use_ethernet_fw_stream = use_ethernet_fw_stream; }
    ...
    void set_is_post_tm_relay_buf(bool is_post_tm_relay_buf) { m_is_post_tm_relay_buf = is_post_tm_relay_buf; }
    ...
    // Returns true if buffer has a specific output pipe.
    bool has_output_pipe_id(NodeId pipe_id) const;
