...
namespace pipegen2
{
    ...
    public:
        ...
        // padding input buffers).
        std::unordered_set<const PGBuffer*> get_unique_input_buffers() const;
        ...
        std::unordered_set<const PGBuffer*> get_unique_output_padding_buffers() const;

        // Returns a set of all unique input buffer which includes the output padding buffers.
        std::unordered_set<const PGBuffer*> get_unique_input_buffers_including_output_padding() const;
