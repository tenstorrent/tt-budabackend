...
public:
    ...
    std::vector<std::unique_ptr<RationalGraph>> create_rational_graphs(
        const PipeGraph& pipe_graph, ResourceManager* resource_manager);

private:
    // Creates rational graph from pipe graph subgraph.
    std::unique_ptr<RationalGraph> create_rational_graph(
    ...
    std::unique_ptr<RGBasePipe> create_relay_pipe(
    ...
    std::unique_ptr<RGBasePipe> create_ethernet_relay_pipe(
    ...
    tt_cxy_pair choose_location_of_pipe_sending_to_pcie(
    ...
    void connect_rg_pipe_with_input_nodes(
    ...
    void connect_rg_pipe_with_input_node(
    ...
    void connect_rg_pipe_with_output_nodes(RGBasePipe* rg_pipe, const std::vector<PGBuffer*>& pg_pipe_outputs);
    ...
    void create_parallel_fork_for_node(
    ...
    static std::unique_ptr<ForkPipe> create_dram_parallel_fork_pipe_for_node(
    ...
    std::unique_ptr<VirtualNode> create_fork_node_for_rg_edge(
    ...
    static tt_cxy_pair get_physical_location(
    ...
    void manage_gather_optimizations(
    ...
    void allocate_kernel_input_index(
    ...
    // due to implementation details of overlay decouple perf infra:
    // tenstorrent/budabackend#2074).
    void allocate_kernel_output_index(
        ResourceManager* resource_manager, std::vector<std::unique_ptr<RationalGraph>>& rational_graphs);
