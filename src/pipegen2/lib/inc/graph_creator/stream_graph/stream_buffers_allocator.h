...
namespace pipegen2
{
    ...
    public:
        ...
        bool has_allocated_buffer(const unsigned int buffer_size, const unsigned long dram_buf_noc_addr) const;
    ...
    private:
        ...
        std::unordered_map<unsigned int, std::unordered_map<unsigned long, unsigned int>> m_allocated_padding_buffers;
    };
