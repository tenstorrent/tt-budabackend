...
class DramPrefetchPostTMMulticastStreamsCreator : public PipeStreamsCreator
{
public:
    DramPrefetchPostTMMulticastStreamsCreator(
...
private:
    ...
    // Dram read common streams creator instance.
