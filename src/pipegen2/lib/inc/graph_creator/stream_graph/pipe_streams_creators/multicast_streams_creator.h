...
namespace pipegen2
{
    ...
    private:
        ...
        std::unique_ptr<StreamNode> create_multicast_stream(const RGBasePipe* pipe,
                                                            const DataFlowInfo& data_flow_info);
        ...
        std::vector<std::unique_ptr<StreamNode>> create_unpacker_receiving_streams(const RGBasePipe* pipe,
                                                                                   const DataFlowInfo& data_flow_info);
