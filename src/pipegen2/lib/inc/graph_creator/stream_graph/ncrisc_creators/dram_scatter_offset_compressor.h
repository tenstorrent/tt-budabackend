...
public:
    ...
    static ScatterPatternCompressionResult no_compression() { return ScatterPatternCompressionResult(0, 0, 0); }
    ...
    std::uint64_t get_num_loops() const { return m_num_loops; }

    std::size_t get_pattern_length() const { return m_pattern_length; }

    std::uint64_t get_increment() const { return m_increment; }
...
private:
    bool has_compression() const { return m_num_loops > 0; }
...
private:
    ...
    ScatterPatternCompressionResult get_scatter_pattern_compression(
    ...
    std::size_t get_compression_scatter_pattern_length(
        const ScatterPatternCompressionResult& scatter_compression, const std::size_t pattern_start_index);
