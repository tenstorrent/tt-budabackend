...
public:
    ...
    // allocation object.
    const L1Buffer* allocate_l1_ncrisc_fallback_buffer(const tt_cxy_pair& core_physical_location,
    ...
    const L1Buffer* allocate_l1_extra_overlay_blob_space(const tt_cxy_pair& core_physical_location,
    ...
    get_worker_core_resources_per_physical_location() const { return m_worker_cores_resources; }
    ...
    unsigned int get_tile_header_buffer_address(const tt_cxy_pair& core_physical_location,
