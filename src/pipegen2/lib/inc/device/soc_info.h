...
public:
    ...
    unsigned long get_buffer_noc_address_through_pcie(const unsigned long pcie_buf_addr, const ChipId chip_id) const;
    ...
    unsigned long get_host_noc_address_through_pcie(const unsigned long host_pcie_buf_addr, const ChipId chip_id) const;
