...
constexpr unsigned long wh_pcie_host_noc_address_offset = 0x800000000;

// PCIe NOC address offset when sending data downstream the NOC.
constexpr unsigned long pcie_downstream_offset = 0x80000000;

// PCIe NOC address offset when sending data upstream the NOC.
constexpr unsigned long pcie_upstream_offset = 0x40000000;
