...
struct address_map {
  ...
  static constexpr std::int32_t NCRISC_L1_RUNTIME_SECTION_BASE = EPOCH_RUNTIME_CONFIG_BASE + EPOCH_RUNTIME_CONFIG_SIZE + OVERLAY_BLOB_SIZE;
  static constexpr std::int32_t NCRISC_L1_RUNTIME_SECTION_SIZE = 16*1024;
  static constexpr std::int32_t NCRISC_L1_SCRATCH_BASE = NCRISC_L1_RUNTIME_SECTION_BASE + 0x200; // L1 Scratch used by NCRISC sized NCRISC_L1_SCRATCH_SIZE, skip 0x200 because some of the beginning of NCRISC is used .e.g. TEST_MAILBOX
  static constexpr std::int32_t NCRISC_L1_CONTEXT_BASE = NCRISC_L1_RUNTIME_SECTION_BASE + 0x20; // If changing make sure to modify src/firmware/riscv/targets/ncrisc/contextASM.S
  static constexpr std::int32_t NCRISC_L1_DRAM_POLLING_CTRL_BASE = NCRISC_L1_RUNTIME_SECTION_BASE + 0x40;
  static constexpr std::int32_t NCRISC_PERF_QUEUE_HEADER_SIZE = 8 * 8; // Half of this value must be 32B aligned
  static constexpr std::int32_t NCRISC_PERF_QUEUE_HEADER_ADDR = NCRISC_L1_RUNTIME_SECTION_BASE + NCRISC_L1_SCRATCH_SIZE; // L1 Performance Buffer used by NCRISC
  ...
  static constexpr std::int32_t NCRISC_HAS_IRAM = 0;
  ...
  static constexpr std::int32_t PERF_RISC_MAILBOX_SIZE = 8;
  // Signal to ncrisc that the performance buffer has been drained.
  static constexpr std::int32_t PERF_RESET_PTR_MAILBOX_SIZE = 4;
  ...
  static constexpr std::int32_t PERF_ANALYZER_COMMAND_START_PTR_ADDR = PERF_RESET_PTR_MAILBOX_ADDR + PERF_RESET_PTR_MAILBOX_SIZE;
  static constexpr std::int32_t PERF_ANALYZER_COMMAND_START_VAL_ADDR = PERF_ANALYZER_COMMAND_START_PTR_ADDR + PERF_ANALYZER_COMMAND_START_PTR_SIZE;
  static constexpr std::int32_t BRISC_PERF_BUF_BASE_ADDR = PERF_ANALYZER_COMMAND_START_VAL_SIZE + PERF_UNUSED_SIZE + PERF_ANALYZER_COMMAND_START_VAL_ADDR;
