...
static void noc_transfer(uint64_t src_addr, uint64_t dst_addr, uint32_t size, bool linked, bool posted, bool static_vc_alloc, uint32_t static_vc, bool multicast, uint32_t multicast_mode, bool src_local, uint32_t vc_arb_priority, uint8_t transaction_id) {
...
void noc_copy(uint64_t src_addr, uint64_t dst_addr, uint32_t size, bool linked, bool posted, bool static_vc_alloc, uint32_t static_vc, uint32_t vc_arb_priority, uint8_t transaction_id) {
  ...
  noc_transfer(src_addr, dst_addr, size, linked, posted, static_vc_alloc, static_vc, false, 0, src_local, vc_arb_priority, transaction_id);
}

static void transfer_word_be(uint64_t src_addr, uint64_t dst_addr, uint32_t be, bool linked, bool posted, bool static_vc_alloc, uint32_t static_vc, bool multicast, uint32_t multicast_mode, uint8_t transaction_id) {
  while (!noc_command_ready());
  NOC_WRITE_REG(NOC_TARG_ADDR_LO, (uint32_t)(src_addr & 0xFFFFFFFF));
  NOC_WRITE_REG(NOC_TARG_ADDR_MID, (uint32_t)(src_addr >> 32));
  NOC_WRITE_REG(NOC_RET_ADDR_LO, (uint32_t)(dst_addr & 0xFFFFFFFF));
...
void noc_multicast_write_dw_inline(uint64_t dst_addr, uint32_t val, uint32_t multicast_mode, uint8_t be, bool linked, bool posted, bool static_vc_alloc, uint32_t static_vc, uint8_t transaction_id) {
  noc_transfer_dw_inline(dst_addr, val, be, linked, posted, static_vc_alloc, static_vc, true, multicast_mode, transaction_id);
}
...
void noc_multicast_copy_word_be(uint64_t src_addr, uint64_t dst_addr, uint32_t multicast_mode, uint32_t be, bool linked, bool posted, bool static_vc_alloc, uint32_t static_vc, uint8_t transaction_id) {
  transfer_word_be(src_addr, dst_addr, be, linked, posted, static_vc_alloc, static_vc, true, multicast_mode, transaction_id);
}
...
void noc_multicast_copy(uint64_t src_addr, uint64_t dst_addr, uint32_t multicast_mode, uint32_t size, bool linked, bool posted, bool static_vc_alloc, uint32_t static_vc, uint8_t transaction_id) {
  noc_transfer(src_addr, dst_addr, size, linked, posted, static_vc_alloc, static_vc, true, multicast_mode, unicast_addr_local(src_addr), 0, transaction_id);
}
