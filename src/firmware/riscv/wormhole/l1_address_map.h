...
struct address_map {
  ...
  static constexpr std::uint32_t NCRISC_DATA_BASE = NCRISC_FIRMWARE_BASE; // Defined at tensix-memory.ld. Overloads the NCRISC_FIRMWARE_BASE that is copied to IRAM.
