...
struct address_map {
  ...
  static constexpr std::uint32_t L1_BARRIER_BASE = 0xfffc0;
  ...
  static constexpr std::uint32_t MAX_SIZE = 1 * 1024 * 1024;  // 1MB
  static constexpr std::uint32_t MAX_L1_LOADING_SIZE = MAX_SIZE;
