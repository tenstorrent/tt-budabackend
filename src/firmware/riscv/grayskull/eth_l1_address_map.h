...
struct address_map {
  ...
  static constexpr std::int32_t FW_DRAM_BLOCK_SIZE = FIRMWARE_SIZE + OVERLAY_BLOB_SIZE + OVERLAY_MAX_EXTRA_BLOB_SIZE + EPOCH_RUNTIME_CONFIG_SIZE + TILE_HEADER_BUF_SIZE;
  ...
  static constexpr std::int32_t EPOCH_RUNTIME_CONFIG_BASE = FIRMWARE_BASE + FIRMWARE_SIZE + TILE_HEADER_BUF_SIZE;
