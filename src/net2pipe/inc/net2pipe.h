...
protected:
  ...
  std::unordered_map<chip_id_t, buda_SocDescriptor> soc_descriptors;
  ...
  int get_op_kernel_input_size_tiles(tt_op_info op_info, int index, const temporal_epoch_context& epoch_context) const;
