...
class Router {
  public:
   Router(
    ...
    const buda_SocDescriptor &get_soc_descriptor() const { return soc_descriptor; }
    ...
    int get_noc_distance(int noc_id, int src_y_noc0_routing, int src_x_noc0_routing, int dest_y_noc0_routing, int dest_x_noc0_routing) const;
    int get_noc0_distance(int src_y_noc0_routing, int src_x_noc0_routing, int dest_y_noc0_routing, int dest_x_noc0_routing) const;
    int get_noc1_distance(int src_y_noc0_routing, int src_x_noc0_routing, int dest_y_noc0_routing, int dest_x_noc0_routing) const;
    int get_shortest_path_noc_id(int src_y_noc0_routing, int src_x_noc0_routing, int dest_y_noc0_routing, int dest_x_noc0_routing) const;
  ...
  private:
    ...
    static std::unordered_map<tt_xy_pair, dram_channel_t> initialize_dram_core_map(const buda_SocDescriptor &soc_descriptor);
    static std::unordered_map<tt_cxy_pair, std::unique_ptr<CoreResources>> initialize_hw_cores(const buda_SocDescriptor &soc_descriptor, const AddressMap &address_map, const std::vector<chip_id_t> &chip_ids);
