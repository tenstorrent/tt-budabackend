...
#include "src/firmware/riscv/grayskull/l1_address_map.h"
#include "src/firmware/riscv/grayskull/eth_l1_address_map.h"
#include "net2pipe_constants.h"

AddressMap AddressMap::ForGrayskull() {
    return AddressMap(
        tt::ARCH::GRAYSKULL,
        ...
        ArchConstants{.MAX_MCAST_STREAMS_PER_CORE=MAX_MCAST_STREAMS_PER_CORE_GRAYSKULL}
    );
}
