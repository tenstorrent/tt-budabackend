...
template <bool untilize = false, bool is_fp32_dest_acc_en = false, ReluType relu_type = ReluType::NO_RELU, std::uint32_t relu_threshold = 0, bool tilize = false>
inline void llk_pack_hw_configure_disaggregated(std::uint32_t pack_output) {
    TT_LLK_DUMP("llk_pack_hw_configure_disaggregated<{}, {}, {}, {}, {}>({})", untilize, is_fp32_dest_acc_en, relu_type, relu_threshold, tilize, pack_output);
...
inline void llk_pack_init(const std::uint32_t pack_output) {
    TT_LLK_DUMP("llk_pack_init<{}, {}, {}, {}, {}>({})", untilize, zero_output, FaceLayout, write_tile_header, tilize, pack_output);
