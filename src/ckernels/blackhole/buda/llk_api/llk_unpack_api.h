...
inline void llk_unpack_AB_matmul(
    ...
    TT_LLK_DUMP("llk_unpack_AB_matmul(opA:{}, opB:{}, tileIdxA:{}, tileIdxB:{})", operandA, operandB, tile_index_a, tile_index_b);
    TT_LLK_DUMP("llk_unpack_AB_matmul(ct:{}, rt:{}, kt:{})", ct_dim, rt_dim, kt_dim);
